		...
		public static IDictionary<string, string> Tags {
			get {
				var dict = new Dictionary<string, string> {
					...
					{ "Mining",                 "Mechanics: Adds or changes mining mechanics." },
					...
					{ "Misc. Interactions",		"Mechanics: Adds new block interactions, fishing mechanics, NPC dialogues, etc." },
					...
					{ "The Beginning",			"When: Focuses on time before any boss kills or invasion events." },
					{ "Bosses Begun",           "When: Focuses on time after player has begun killing bosses (world now mostly accessible)." },
					{ "Post-BoC & EoW",         "When: Focuses on time after corruption/crimson conquered. Underworld accessible." },
					{ "Hard Mode",              "When: Focuses on time after Wall of Flesh conquered (hallowed+evil biomes, harder monsters)." },
					{ "Post-Mech bosses",       "When: Focuses on time after Mech bosses conquered (restless jungle)." },
					{ "Post-Plantera",          "When: Focuses on time after Plantera conquered. Temple accessible." },
					{ "Post-Moonlord",          "When: Focuses on time after Moon Lord killed." },
					{ "Contextual",             "When: Concerns with a specific, discrete event or (non-boss) game context." },
					...
					{ "Needs New World",        "Playing an existing world is difficult, problematic, or just impossible." },
					...
					{ "Misleading Info",        "Not what it says on the tin or contains missing information (e.g. poor mod description)." },
					//{ "Rated R",                "Guess." },
