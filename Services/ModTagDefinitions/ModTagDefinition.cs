	...
	public partial class ModTagDefinition {
		...
		static ModTagDefinition() {
			...
			var list = new List<ModTagDefinition> {
				...
				m( tag: "Mounts & Familiars",		"Content",  "Adds or edits player mounts or gameplay-affecting 'pets'."),
				...
				m( tag: "Pets",						"Content",  "Adds or edits player pets."),
				...
				m( tag: "Mounts Emphasis",			"Content",  "Emphasizes added or modified player mounts or gameplay-affecting 'pets'.",
