	...
	public partial class ModTagDefinition {
		...
		static ModTagDefinition() {
			...
			var list = new List<ModTagDefinition> {
				...
				//m( tag: "Easings",
				//	cat: "General",		"Decreases difficulty of specific elements: Stronger weapons, added player defense, etc."),
				...
				m(	tag: "Needs Credentials",
					cat: "Privilege",
					desc: "Requires input of user information for features to work.",
					flavor: TagFlavor.TechnicallyImportant ),
