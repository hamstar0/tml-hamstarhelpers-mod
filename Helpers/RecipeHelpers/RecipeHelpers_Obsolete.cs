...
namespace HamstarHelpers.RecipeHelpers {
	public partial class RecipeHelpers {
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"MagicMirrors\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"VanillaAnimals\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"VanillaBugs\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"MobBanners\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"RecordedMusicBox\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"AlchemyHerbs\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"StrangePlants\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"PressurePlates\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"WeightedPressurePlates\"]", true )]
		...
		[Obsolete( "Use RecipeHelpers.Groups[\"ConveyorBelts\"]", true )]
