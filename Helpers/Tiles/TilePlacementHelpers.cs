...
namespace HamstarHelpers.Helpers.Tiles {
	...
	public partial class TilePlacementHelpers {
		...
		/// <param name="style"></param>
		public static void Place4x2( int leftX, int topY, ushort type, int direction = -1, int style = 0 ) {
		...
		/// <param name="direction"></param>
		/// <param name="style"></param>
		public static void Place6x3( int leftX, int topY, ushort type, int direction = -1, int style = 0 ) {
		...
		/// <param name="type"></param>
		/// <param name="style"></param>
		public static void Place6x4( int leftX, int topY, ushort type, int style = 0 ) {
